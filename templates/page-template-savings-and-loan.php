<?php
/**
 * Savings & Loan Detail Page Template
 * 
            ...
            <div class="financial-table">
                ...
                <table>
                    <tbody>
                        ...
                        <?php endif; ?>
                        <?php if ($institution['repos_invest_re']): ?>
                        <tr>
                            <td>Repos, Investment RE</td>
                            <td class="text-right"><?= formatCurrencyThousands($institution['repos_invest_re']) ?></td>
                        </tr>
                        <?php endif; ?>
            ...
            <div class="financial-table">
                ...
                <table>
                    <tbody>
                        ...
                        <?php endif; ?>
                        <?php if ($institution['fhlb_advances']): ?>
                        <tr>
                            <td>FHLB Advances</td>
                            <td class="text-right"><?= formatCurrencyThousands($institution['fhlb_advances']) ?></td>
                        </tr>
                        <?php endif; ?>
                        <?php if ($institution['all_other_liabilities']): ?>
                        <tr>
                            <td>All Other Liabilities</td>
                            <td class="text-right"><?= formatCurrencyThousands($institution['all_other_liabilities']) ?></td>
                        </tr>
                        <?php endif; ?>
